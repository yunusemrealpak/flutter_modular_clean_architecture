...
void main() {
  ...
  setUp(() {
    ...
    httpClient = HttpClient(config: config, networkInfo: networkInfo, dio: dio);
  });
  ...
  group('HttpClient GET Tests', () {
    ...
    test('GET request with query parameters should work', () async {
      ...
      // Act
      final response = await httpClient.get(path, queryParameters: queryParams);
  ...
  group('HttpClient DELETE Tests', () {
    test('DELETE request should work correctly', () async {
      ...
      dioAdapter.onDelete(path, (server) => server.reply(204, null));
  ...
  group('HttpClient Auth Interceptor Tests', () {
    test('should add auth interceptor correctly', () {
      ...
      // Assert
      final hasAuthInterceptor = httpClient.dio.interceptors.any(
